...
export class PrimeraMigracion1645091282177 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "work-time-logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "hours" smallint NOT NULL, "date" date NOT NULL, "user_id" integer NOT NULL, "project_id" integer NOT NULL, CONSTRAINT "PK_a22a28169a31ebb39569f5003b7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "projects_nests" ("id" SERIAL NOT NULL, "key" character varying(16) NOT NULL, "title" character varying(80) NOT NULL, "description" text NOT NULL, "planned_hours" integer NOT NULL, CONSTRAINT "UQ_32c27404973ad2cae565667607b" UNIQUE ("key"), CONSTRAINT "PK_448731e9b04ec2948016c5edf14" PRIMARY KEY ("id")); COMMENT ON COLUMN "projects_nests"."key" IS 'Key unica del proyecto'; COMMENT ON COLUMN "projects_nests"."title" IS 'Titulo del proyecto'`,
    );
    await queryRunner.query(
      `ALTER TABLE "work-time-logs" ADD CONSTRAINT "FK_901ebd93779803ce70d4ebc429c" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "work-time-logs" ADD CONSTRAINT "FK_7a646e050d0891990981f045f74" FOREIGN KEY ("project_id") REFERENCES "projects_nests"("id") ON DELETE NO ACTION ON UPDATE CASCADE`,
    );
  }
